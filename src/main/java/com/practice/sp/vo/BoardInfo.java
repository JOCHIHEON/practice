...
public class BoardInfo {
	...
	public List<BoardInfo> getBiList() {
		return biList;
	}
	public void setBiList(List<BoardInfo> biList) {
		this.biList = biList;
	}
	private List<BoardInfo> biList;
}
